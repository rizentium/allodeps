...
class PrinterBluetooth {
  ...
  PrinterBluetooth.fromPlayer(Map<String, dynamic> value) {
  ...
  set setNameDevice(val) => _device.name = val;
  set setAddressDevice(val) => _device.address = val;
  set setType(val) => _device.type;
}
